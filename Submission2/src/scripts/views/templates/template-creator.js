...
const createRestoItemTemplate = (restaurants) => `
  <div class="resto-item">
    ...
    <h3><a class="tombol" href=${`/#/detail/${restaurants.id}`}>${restaurants.name}</a></h3>
</div>
    <figure>
